...
class CSABlock(nn.Module):
    ...
    def forward(self, x, layer_past=None):
        ...
        # Reshape to separate heads: (B, L, C) -> (B, L, n_head, C/n_head) -> (B, n_head, L, C/n_head)
        ...
        att = (Q @ K.transpose(-2, -1)) * (1.0 / math.sqrt(K.size(-1)))  # (B, n_head, L, L)
        ### END YOUR CODE ###
        ...
        # Recombine heads: (B, n_head, L, C/n_head) -> (B, L, n_head, C/n_head) -> (B, L, C)
